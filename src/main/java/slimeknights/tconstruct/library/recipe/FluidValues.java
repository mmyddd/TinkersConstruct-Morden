 ...
 * <p>
 * Use these values when registering casting/melting interactions to ensure if
 * the fluid API changes the values are still correct
 */
...
public final class FluidValues {
    ...
    /**
     * Value of a single metal ingot, is divisible by 4&9
     */
     ...
     */
    public static final int GEM = 1600;
    /**
     ...
     */
    public static final int BRICK = 400;
    /**
     * Value of a single metal brick block, is divisible by 16
     */
    ...
    // slime
    /**
     * Value of a single slimeball, also used for clay, slime substitutes, and
     * ender pearls
     */
    public static final int SLIMEBALL = 400;
    /**
    ...
    /**
     * Amount of ichor returned from melting 1 ball of ichor, needs to be less
     * than {@link #SLIMEBALL} or you get dupes.
     */
    public static final int ICHOR_BYPRODUCT = SLIME_DROP * 4;
    /**
     * Amount of blazing blood returned from melting 1 ball of ichor, makes a
     * stack of ichor crystal blocks about 2 buckets
     */
     ...
     */
    public static final int BOWL = 400;
    /**
     * Value of a single bottle of a potion
     */
    public static final int BOTTLE = 400;
    /**
     ...
     */
    public static final int LANTERN_CAPACITY = 80;
}
