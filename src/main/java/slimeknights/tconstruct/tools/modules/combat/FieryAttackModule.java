...
public record FieryAttackModule(LevelingValue time) implements ModifierModule, ProjectileLaunchModifierHook, ProjectileHitModifierHook, MeleeHitModifierHook {
  private static final List<ModuleHook<?>> DEFAULT_HOOKS = HookProvider.<FieryAttackModule>defaultHooks(ModifierHooks.MELEE_HIT, ModifierHooks.PROJECTILE_LAUNCH, ModifierHooks.PROJECTILE_HIT);
